...
$api = $factory->createUnsubscribeJobStatusApi();
...
try {
    $response = $api->unsubscribeJobStatus($jobGuid, $endpoint);
    echo "Unsubscribe job status request sent for GUID {$jobGuid->value}.\n";
    ...
    } elseif ($response->statusCode->isNotFound()) {
        echo "Not Found (404) - Subscription not found\n";
    } else {
